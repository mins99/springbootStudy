package com.study.spring.login.config;
...
import com.study.spring.login.oauth2.CustomOAuth2Provider;

import java.util.List;
import java.util.Objects;
import java.util.stream.Collectors;

import static com.study.spring.board.enums.SocialType.FACEBOOK;
import static com.study.spring.board.enums.SocialType.GOOGLE;
import static com.study.spring.board.enums.SocialType.KAKAO;
